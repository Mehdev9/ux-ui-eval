    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-start">
                <a href="{{ route('profil.edit') }}" class="btn btn-primary rounded-pill px-4">Modifier le profil</a>
                <a href="{{ route('profil.password.edit') }}" class="btn btn-danger rounded-pill px-4 ms-5">Changer de mot de passe</a>
            </div>
        </div>
    </div>
</div>
