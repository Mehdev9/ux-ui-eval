                        ...
                        <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('products.show', ['product' => 3]) }}" class="btn btn-primary rounded-pill px-4">Voir le produit</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('products.show', ['product' => 4]) }}" class="btn btn-primary rounded-pill px-4">Voir le produit</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="100">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Recevez vos commandes en un temps record grâce à nos partenaires logistiques.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="300">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <p class="card-text">Nous sélectionnons rigoureusement nos produits pour vous garantir la meilleure qualité.</p>
                    </div>
                </div>
            </div>
        </div>
